...
export interface ClientOptions {
   ...
   *
   * Defaults to process.env['ERIC_COOOOOOOO_BASE_URL'].
   */
   ...
   * Set the log level.
   *
   * Defaults to process.env['ERIC_COOOOOOOO_LOG'] or 'warn' if it isn't set.
   */
...
/**
 * API Client for interfacing with the Eric Coooooooo API.
 */
export class EricCoooooooo {
  apiKey: string;
   ...
   * @param {string} [opts.baseURL=process.env['ERIC_COOOOOOOO_BASE_URL'] ?? https://petstore3.swagger.io/api/v3] - Override the default base URL for the API.
   ...
   */
  constructor({
    baseURL = readEnv('ERIC_COOOOOOOO_BASE_URL'),
    apiKey = readEnv('PETSTORE_API_KEY'),
    ...opts
  }: ClientOptions = {}) {
    if (apiKey === undefined) {
      throw new Errors.EricCooooooooError(
        "The PETSTORE_API_KEY environment variable is missing or empty; either provide it, or instantiate the EricCoooooooo client with an apiKey option, like new EricCoooooooo({ apiKey: 'My API Key' }).",
      );
    }
    ...
    this.timeout = options.timeout ?? EricCoooooooo.DEFAULT_TIMEOUT /* 1 minute */;
    ...
    this.logLevel =
      ...
      parseLogLevel(readEnv('ERIC_COOOOOOOO_LOG'), "process.env['ERIC_COOOOOOOO_LOG']", this) ??
      defaultLogLevel;
  ...
  static EricCoooooooo = this;
  static DEFAULT_TIMEOUT = 60000; // 1 minute

  static EricCooooooooError = Errors.EricCooooooooError;
...
EricCoooooooo.Pets = Pets;
EricCoooooooo.Store = Store;
EricCoooooooo.UserResource = UserResource;
export declare namespace EricCoooooooo {
