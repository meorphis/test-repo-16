...
export interface ClientOptions {
   ...
   *
   * Defaults to process.env['ERIC_COOOOOOOOO_BASE_URL'].
   */
   ...
   * Set the log level.
   *
   * Defaults to process.env['ERIC_COOOOOOOOO_LOG'] or 'warn' if it isn't set.
   */
...
/**
 * API Client for interfacing with the Eric Cooooooooo API.
 */
export class EricCooooooooo {
  apiKey: string;
   ...
   * @param {string} [opts.baseURL=process.env['ERIC_COOOOOOOOO_BASE_URL'] ?? https://petstore3.swagger.io/api/v3] - Override the default base URL for the API.
   ...
   */
  constructor({
    baseURL = readEnv('ERIC_COOOOOOOOO_BASE_URL'),
    apiKey = readEnv('PETSTORE_API_KEY'),
    ...opts
  }: ClientOptions = {}) {
    if (apiKey === undefined) {
      throw new Errors.EricCoooooooooError(
        "The PETSTORE_API_KEY environment variable is missing or empty; either provide it, or instantiate the EricCooooooooo client with an apiKey option, like new EricCooooooooo({ apiKey: 'My API Key' }).",
      );
    }
    ...
    this.timeout = options.timeout ?? EricCooooooooo.DEFAULT_TIMEOUT /* 1 minute */;
    ...
    this.logLevel =
      ...
      parseLogLevel(readEnv('ERIC_COOOOOOOOO_LOG'), "process.env['ERIC_COOOOOOOOO_LOG']", this) ??
      defaultLogLevel;
  ...
  static EricCooooooooo = this;
  static DEFAULT_TIMEOUT = 60000; // 1 minute

  static EricCoooooooooError = Errors.EricCoooooooooError;
...
EricCooooooooo.Pets = Pets;
EricCooooooooo.Store = Store;
EricCooooooooo.UserResource = UserResource;
export declare namespace EricCooooooooo {
