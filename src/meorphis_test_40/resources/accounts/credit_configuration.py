...
class CreditConfigurationResource(SyncAPIResource):
    @cached_property
    def with_raw_response(self) -> CreditConfigurationResourceWithRawResponse:
        return CreditConfigurationResourceWithRawResponse(self)
...
class AsyncCreditConfigurationResource(AsyncAPIResource):
    @cached_property
    def with_raw_response(self) -> AsyncCreditConfigurationResourceWithRawResponse:
        return AsyncCreditConfigurationResourceWithRawResponse(self)
