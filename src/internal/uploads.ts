...
import type { EricCompositioning } from '../client';
...
export const maybeMultipartFormRequestOptions = async (
  opts: RequestOptions,
  fetch: EricCompositioning | Fetch,
 ...
 */
function supportsFormData(fetchObject: EricCompositioning | Fetch): Promise<boolean> {
