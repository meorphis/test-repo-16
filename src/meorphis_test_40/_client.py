...
__all__ = ["ENVIRONMENTS", "Timeout", "Transport", "ProxiesTypes", "RequestOptions", "resources", "MeorphisTest40", "AsyncMeorphisTest40", "Client", "AsyncClient"]
...
class MeorphisTest40(SyncAPIClient):
    ...
    def __init__(self, *, environment: Literal["production","environment_1"] | NotGiven = NOT_GIVEN, base_url: str | httpx.URL | None | NotGiven = NOT_GIVEN, timeout: Union[float, Timeout, None, NotGiven] = NOT_GIVEN, max_retries: int = DEFAULT_MAX_RETRIES, default_headers: Mapping[str, str] | None = None, default_query: Mapping[str, object] | None = None, 
    ...
    _strict_response_validation: bool = False) -> None:
        ...
        if is_given(base_url) and base_url is not None:
          ...
          if base_url_env and base_url is not None:
            raise ValueError(
              'Ambiguous URL; The `MEORPHIS_TEST_40_BASE_URL` env var and the `environment` argument are given. If you want to use the environment, you must pass base_url=None',
            )
...
AsyncClient = AsyncMeorphisTest40